...
public class MSquare
{
	...
	static int count = 0;
	static int dist[];
	static int totalNumNodes = 40320;

	public MSquare(String inputUserString)
	{
...
//			itterQueue.enqueue(new QNode(i, startState));
//		}
	...
	private static boolean processNeighbors(QNode x)
	{
		...
		MSquare nMSquare3 = new MSquare(word);
...
//	}
	...
	public void dijkstraBFS(StringMap inMap, int src) {
		...
		queue.enqueue(new QNode(src, startState));
